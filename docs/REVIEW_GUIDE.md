...
This guide is meant for anyone who wants the clearest path through the
application without getting tripped up by preview features.
...
If you only have a few minutes, show these three things:
