...
- Dockerized local setup for reviewers and teammates
...
- not the recommended path for the professor demo
...
- better reviewer tooling for inspecting project memory transitions
